...
class TriviaQuiz:
    ...
    def __init__(self, quiz: QuizBrain):
        ...
        self.button_true = Button(image=true_img, highlightthickness=0, command=self.check_if_true)
        self.button_false = Button(image=false_img, highlightthickness=0, command=self.check_if_false)
